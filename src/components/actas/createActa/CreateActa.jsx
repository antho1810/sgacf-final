...
const CreateActa = () => {
  ...
  const [objIdMiembrosTotales, setObjIdMiembrosTotales] = useState([]);
  ...
  const handleCheckboxChange = (participantId) => {
    ...
    const checkId = objIdPresentes.find((_id) => _id === participantId);

    if (checkId) {
      console.log(`Id: ${participantId} ya fue añadido`);
    } else {
        ...
        <div className="container-fluid mb-4">
          <div className="row" style={{ gap: "20px" }}>
            <div className="col h-auto d-flex flex-column justify-content-center">
              ...
              {/* Paginacion - Participante Component*/}
              <div
